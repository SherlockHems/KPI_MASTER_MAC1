...
def main():
    ...
    initial_holdings = load_initial_holdings('/content/drive/MyDrive/WORK/2023DEC.csv')

    print("\nLoading trades...")
    trades = load_trades('/content/drive/MyDrive/WORK/TRADES_LOG.csv')

    print("\nLoading product info...")
    product_info = load_product_info('/content/drive/MyDrive/WORK/PRODUCT_INFO.csv')

    print("\nLoading client sales info...")
    client_sales = load_client_sales('/content/drive/MyDrive/WORK/CLIENT_LIST.csv')
